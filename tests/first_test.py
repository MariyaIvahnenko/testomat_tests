...
def test_search_non_existing_project(page: Page, login):
...
def test_presence_button_create_company_to_upgrade(page: Page, login):
    page.locator("#company_id").click()
    page.locator("#company_id").select_option("Free Projects")
...
def test_checking_the_documentation_page(page: Page, login):
    page.locator("#company_id").click()
    page.locator("#company_id").select_option("Free Projects")
